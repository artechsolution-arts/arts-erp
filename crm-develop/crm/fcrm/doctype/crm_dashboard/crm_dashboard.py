...
def create_default_manager_dashboard(force=False):
	...
	"""
	if not artech_engine.db.exists("CRM Dashboard", "Manager Dashboard"):
		doc = artech_engine.new_doc("CRM Dashboard")
		doc.title = "Manager Dashboard"
		doc.layout = default_manager_dashboard_layout()
		doc.insert(ignore_permissions=True)
	else:
		doc = artech_engine.get_doc("CRM Dashboard", "Manager Dashboard")
		if force:
			doc.layout = default_manager_dashboard_layout()
