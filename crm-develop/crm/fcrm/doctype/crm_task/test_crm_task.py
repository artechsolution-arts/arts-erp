...
class TestCRMTask(IntegrationTestCase):
	...
	def test_update_assigned_user(self):
		...
		task = artech_engine.get_doc("CRM Task", task.name)
	...
	def test_task_priority_ordering(self):
		...
		high_priority_tasks = artech_engine.get_all(
			"CRM Task",
	...
	def test_task_status_workflow_and_filtering(self):
		...
		done_tasks = artech_engine.get_all("CRM Task", filters={"status": "Done"}, fields=["name"])
		...
		active_tasks = artech_engine.get_all(
			"CRM Task",
		...
		canceled_tasks = artech_engine.get_all("CRM Task", filters={"status": "Canceled"}, fields=["name"])
