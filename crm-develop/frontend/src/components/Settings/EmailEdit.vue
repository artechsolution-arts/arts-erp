...
const info = {
  ...
  link: 'https://docs.artech.com/docs/user/manual/en/email-account',
}
...
async function callRenameDoc() {
  const d = await call('artech_engine.client.rename_doc', {
...
async function callSetValue(values) {
  const d = await call('artech_engine.client.set_value', {
    doctype: 'Email Account',
