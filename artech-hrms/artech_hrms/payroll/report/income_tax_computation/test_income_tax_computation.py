...
from artech_hrms.payroll.report.income_tax_computation.income_tax_computation import execute
...
class TestIncomeTaxComputation(HRMSTestSuite):
	...
	def cleanup_records(self):
		artech_engine.db.sql("delete from `tabEmployee Tax Exemption Declaration`")
		artech_engine.db.sql("delete from `tabPayroll Period`")
		artech_engine.db.sql("delete from `tabIncome Tax Slab`")
		artech_engine.db.sql("delete from `tabSalary Component`")
		artech_engine.db.sql("delete from `tabEmployee Benefit Application`")
		artech_engine.db.sql("delete from `tabEmployee Benefit Claim`")
		artech_engine.db.sql("delete from `tabEmployee` where company='_Test Company'")
		artech_engine.db.sql("delete from `tabSalary Slip`")
	...
	def test_get_report_for_all_employees(self):
		artech_engine.db.delete("Employee")
		users = [
		...
		for user in users:
			...
			artech_engine.db.set_value("Employee", employee, user["args"])
