...
class SalaryComponent(Document):
	...
	def clear_cache(self):
		...
		artech_engine.cache().delete_value(SALARY_COMPONENT_VALUES)
		artech_engine.cache().delete_value(TAX_COMPONENTS_BY_COMPANY)
	...
	def update_salary_structures(
		...
		for structure in structures:
			salary_structure = artech_engine.get_doc("Salary Structure", structure)
