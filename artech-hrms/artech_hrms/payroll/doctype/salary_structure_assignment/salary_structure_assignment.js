artech_engine.ui.form.on("Salary Structure Assignment", {
	setup: function (frm) {
	...
	refresh: function (frm) {
		...
		frm.add_custom_button(
			__("Payroll Entry"),
			() => {
				artech_engine.model.with_doctype("Payroll Entry", () => {
					const doc = artech_engine.model.get_new_doc("Payroll Entry");
					artech_engine.set_route("Form", "Payroll Entry", doc.name);
				});
			},
			__("Create"),
		);
	...
	salary_structure: (frm) => {
		if (frm.doc.salary_structure) {
			artech_engine.db.get_doc("Salary Structure", frm.doc.salary_structure).then((doc) => {
...
artech_engine.ui.form.on("Employee Benefit Detail", {
