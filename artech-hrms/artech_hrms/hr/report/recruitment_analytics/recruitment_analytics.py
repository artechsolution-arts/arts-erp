...
def get_staffing_plan(filters):
	...
	StaffingPlan = artech_engine.qb.DocType("Staffing Plan")
	StaffingPlanDetail = artech_engine.qb.DocType("Staffing Plan Detail")

	query = (
		artech_engine.qb.from_(StaffingPlanDetail)
		.join(StaffingPlan)
...
def get_job_applicant(jo_list):
	...
	applicants = artech_engine.get_all(
		"Job Applicant",
