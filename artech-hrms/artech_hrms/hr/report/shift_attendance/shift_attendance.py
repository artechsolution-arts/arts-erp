...
from artech_engine.utils import cint, flt, format_datetime, format_duration
...
def get_attendance_with_checkins(filters):
	...
	checkin = artech_engine.qb.DocType("Employee Checkin")
	shift_type = artech_engine.qb.DocType("Shift Type")
