...
class TestEmployeeExits(HRMSTestSuite):
	...
	def test_employee_exits_summary(self):
		...
		employee1 = artech_engine.get_doc("Employee", self.emp1)
		employee2 = artech_engine.get_doc("Employee", self.emp2)
		expected_data = [
			{
	...
	def test_pending_exit_interviews_summary(self):
		...
		employee4 = artech_engine.get_doc("Employee", self.emp4)
		expected_data = [
			{
	...
	def test_pending_fnf_summary(self):
		...
		employee3 = artech_engine.get_doc("Employee", self.emp3)
		employee4 = artech_engine.get_doc("Employee", self.emp4)
		expected_data = [
			{
