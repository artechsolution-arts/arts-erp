...
class TestEmployeeUtilization(HRMSTestSuite):
	def setUp(self):
		...
		artech_engine.db.set_single_value("HR Settings", "standard_working_hours", 9)

	def create_test_timesheets(self):
		timesheet1 = artech_engine.new_doc("Timesheet")
		...
		timesheet2 = artech_engine.new_doc("Timesheet")
	...
	def test_utilization_report_for_single_employee(self):
		...
		emp1_data = artech_engine.get_doc("Employee", self.test_emp1)
		expected_data = [
			{
				"employee": self.test_emp1,
	...
	def test_utilization_report_for_project(self):
		...
		emp2_data = artech_engine.get_doc("Employee", self.test_emp2)
		expected_data = [
			{
