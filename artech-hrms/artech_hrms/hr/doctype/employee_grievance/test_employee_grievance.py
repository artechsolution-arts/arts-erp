...
def create_employee_grievance(raised_by, raised_against, grievance_type):
	grievance = artech_engine.new_doc("Employee Grievance")
...
def create_grievance_type():
	if artech_engine.db.exists("Grievance Type", "Employee Abuse"):
		return artech_engine.get_doc("Grievance Type", "Employee Abuse").name
	grievance_type = artech_engine.new_doc("Grievance Type")
