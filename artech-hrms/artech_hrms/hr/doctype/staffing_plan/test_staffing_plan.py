...
from artech_engine.utils import add_days, get_first_day, get_last_day, getdate, nowdate
...
class TestStaffingPlan(HRMSTestSuite):
	...
	def test_staffing_plan(self):
		artech_engine.db.set_value("Company", "_Test Company 3", "is_group", 1)
		if artech_engine.db.exists("Staffing Plan", "Test"):
			return
		staffing_plan = artech_engine.new_doc("Staffing Plan")
	...
	def test_staffing_plan_subsidiary_company(self):
		...
		if artech_engine.db.exists("Staffing Plan", "Test 1"):
			return
		staffing_plan = artech_engine.new_doc("Staffing Plan")
	...
	def test_staffing_details_from_job_requisition(self):
		...
		staffing_plan.save()
		staffing_plan_detail = artech_engine.db.get_values(
