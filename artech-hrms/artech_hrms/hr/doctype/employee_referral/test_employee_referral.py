...
class TestEmployeeReferral(HRMSTestSuite):
	...
	def test_unique_referral(self):
		...
		self.assertRaises(artech_engine.DuplicateEntryError, create_employee_referral, email="test_ref@example.com")
		referral_1.cancel()
...
def create_employee_referral(email=None, do_not_submit=False):
	emp_ref = artech_engine.new_doc("Employee Referral")
