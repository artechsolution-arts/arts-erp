...
class TestLeaveAdjustment(HRMSTestSuite):
	def setUp(self):
		self.employee = artech_engine.get_doc("Employee", {"first_name": "_Test Employee"})
	...
	def test_duplicate_leave_adjustment(self):
		...
		self.assertRaises(artech_engine.ValidationError, duplicate_adjustment.save)
	...
	def test_adjustment_for_over_allocation(self):
		...
		self.assertRaises(artech_engine.ValidationError, leave_adjustment.save)
