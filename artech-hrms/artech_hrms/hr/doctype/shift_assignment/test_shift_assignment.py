...
from artech_engine.utils import add_days, get_datetime, getdate, now_datetime, nowdate
...
class TestShiftAssignment(HRMSTestSuite):
	...
	def test_multiple_shift_assignments_for_same_date(self):
		...
		artech_engine.db.set_single_value("HR Settings", "allow_multiple_shift_assignments", 0)
	...
	def test_consecutive_day_and_night_shifts(self):
		...
		artech_engine.db.set_value("Employee", employee, "default_shift", shift_type.name)
