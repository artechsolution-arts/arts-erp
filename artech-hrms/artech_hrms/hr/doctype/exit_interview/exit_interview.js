artech_engine.ui.form.on("Exit Interview", {
	refresh: function (frm) {
		if (
			!frm.doc.__islocal &&
			!frm.doc.questionnaire_email_sent &&
			artech_engine.boot.user.can_write.includes("Exit Interview")
		) {
	...
	employee: function (frm) {
		artech_engine.db.get_value("Employee", frm.doc.employee, "relieving_date", (message) => {
