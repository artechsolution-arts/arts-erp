...
from artech_engine.utils import cstr, flt, nowdate, random_string
...
class TestVehicleLog(HRMSTestSuite):
	...
	def test_make_vehicle_log_and_syncing_of_odometer_value(self):
		...
		vehicle = artech_engine.get_doc("Vehicle", self.license_plate)
...
def make_vehicle_log(license_plate, employee_id, with_services=False):
	vehicle_log = artech_engine.get_doc(
		{
			"doctype": "Vehicle Log",
			"license_plate": cstr(license_plate),
			"employee": employee_id,
