...
export const myLeaves = createResource({
	url: "artech_hrms.api.get_leave_applications",
	params: {
		employee: employeeResource.data.name,
		limit: 10,
	},
	auto: true,
	cache: "artech_hrms:my_leaves",
	transform(data) {
...
export const leaveBalance = createResource({
	url: "artech_hrms.api.get_leave_balance_map",
	auto: true,
	cache: "artech_hrms:leave_balance",
	transform: (data) => {
