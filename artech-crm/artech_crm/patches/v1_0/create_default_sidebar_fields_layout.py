...
def execute():
	if not artech_engine.db.exists("CRM Fields Layout", {"dt": "CRM Lead", "type": "Side Panel"}):
		create_doctype_fields_layout("CRM Lead")

	if not artech_engine.db.exists("CRM Fields Layout", {"dt": "CRM Deal", "type": "Side Panel"}):
