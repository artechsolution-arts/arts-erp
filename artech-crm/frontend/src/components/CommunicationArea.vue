...
const signature = createResource({
  url: 'artech_crm.api.get_user_signature',
...
async function sendMail() {
  ...
  await call('artech_engine.core.doctype.communication.email.make', {
...
async function sendComment() {
  ...
  let comment = await call('artech_crm.api.comment.add_comment', {
