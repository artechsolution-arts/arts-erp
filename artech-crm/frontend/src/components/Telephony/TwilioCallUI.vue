...
import { useTelemetry, useOnboarding } from 'frappe-ui/artech_engine'
...
const getContact = createResource({
  url: 'artech_crm.integrations.api.get_contact_by_phone_number',
  makeParams() {
    return {
...
async function startupClient() {
  ...
  try {
    const data = await call('artech_crm.integrations.twilio.api.generate_access_token')
