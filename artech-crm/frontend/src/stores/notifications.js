...
export const notifications = createResource({
  url: 'artech_crm.api.notifications.get_notifications',
  initialData: [],
  auto: true,
})
...
export const notificationsStore = defineStore('artech_crm-notifications', () => {
  const mark_as_read = createResource({
    url: 'artech_crm.api.notifications.mark_as_read',
    onSuccess: () => {
      mark_as_read.params = {}
