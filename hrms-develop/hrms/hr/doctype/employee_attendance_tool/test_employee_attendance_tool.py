...
class TestEmployeeAttendanceTool(HRMSTestSuite):
	def setUp(self):
		artech_engine.db.delete("Attendance")
	...
	def test_get_employees_for_half_day_attendance(self):
		...
		employee = artech_engine.get_doc("Employee", self.employee1)
	...
	def test_update_half_day_attendance(self):
		...
		employee4 = artech_engine.get_doc("Employee", self.employee4)
		employee2 = artech_engine.get_doc("Employee", self.employee2)
		leave_type = create_leave_type(leave_type="_Test Employee Attendance Tool", include_holidays=0)
	...
	def test_get_unmarked_attendance_with_shift(self):
		...
		self.employee1 = artech_engine.get_doc(
			{
				"doctype": "Employee",
		...
		self.employee2 = artech_engine.get_doc(
			{
				"doctype": "Employee",
		...
		self.employee3 = artech_engine.get_doc(
			{
				"doctype": "Employee",
		...
		self.shift_assignment = artech_engine.get_doc(
			{
				"doctype": "Shift Assignment",
				"employee": self.employee1.name,
				"shift_type": self.shift.name,
				"start_date": artech_engine.utils.getdate("2023-02-28"),
				"end_date": artech_engine.utils.getdate("2023-03-10"),
			}
		).insert()
