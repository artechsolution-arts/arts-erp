...
def get_rows(filters):
	...
	SalesInvoiceTimesheet = artech_engine.qb.DocType("Sales Invoice Timesheet")
	SalarySlipTimesheet = artech_engine.qb.DocType("Salary Slip Timesheet")

	query = (
		artech_engine.qb.from_(SalarySlipTimesheet)
