...
class EmployeeBenefitApplication(Document):
	...
	def validate(self):
		...
		if self.employee_benefits:
			...
			artech_engine.throw(_("As per your assigned Salary Structure you cannot apply for benefits"))
	...
	def validate_duplicate_on_payroll_period(self):
		application = artech_engine.db.exists(
	...
	def set_benefit_components_and_currency(self) -> None:
		...
		EmployeeBenefitDetail = artech_engine.qb.DocType("Employee Benefit Detail")
		employee_benefits = (
		...
		if employee_benefits:
			max_benefits, currency = artech_engine.db.get_value(
