artech_engine.ui.form.on("Employee Benefit Application", {
	employee: function (frm) {
		if (frm.doc.employee) {
			artech_engine.run_serially([() => frm.trigger("set_earning_component")]);
		}
	},
...
artech_engine.ui.form.on("Employee Benefit Application Detail", {
	amount: function (frm) {
