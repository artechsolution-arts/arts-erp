...
class TestIncomeTaxDeductions(HRMSTestSuite):
	...
	def create_records(self):
		...
		artech_engine.db.set_single_value("Payroll Settings", "consider_unmarked_attendance_as", "Present")
	...
	def test_report(self):
		filters = artech_engine._dict({"company": "_Test Company"})

		result = execute(filters)
		posting_date = artech_engine.db.get_value("Salary Slip", {"employee": self.employee}, "posting_date")
		expected_data = {
			"employee": self.employee,
