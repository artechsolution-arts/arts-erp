...
from artech_engine import _, get_all
...
def execute(filters=None):
	...
	if artech_engine.db.has_column("Employee", "ifsc_code"):
	...
	for salary in salary_slips:
		if (
			...
			row = {
				...
				"payment_date": artech_engine.utils.formatdate(salary.modified.strftime("%Y-%m-%d")),
				...
				"currency": artech_engine.get_cached_value("Company", filters.company, "default_currency"),
