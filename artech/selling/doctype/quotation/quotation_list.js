artech_engine.listview_settings["Quotation"] = {
	...
	onload: function (listview) {
		...
		if (artech_engine.model.can_create("Sales Order")) {
			listview.page.add_action_item(__("Sales Order"), () => {
				artech.bulk_transaction_processing.create(listview, "Quotation", "Sales Order");
			});
		}

		if (artech_engine.model.can_create("Sales Invoice")) {
			listview.page.add_action_item(__("Sales Invoice"), () => {
				artech.bulk_transaction_processing.create(listview, "Quotation", "Sales Invoice");
			});
		}
	},
