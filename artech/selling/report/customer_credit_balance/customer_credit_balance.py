...
from artech.selling.doctype.customer.customer import get_credit_limit, get_customer_outstanding
...
def execute(filters=None):
	...
	customer_naming_type = artech_engine.get_single_value("Selling Settings", "cust_master_name")
...
def get_details(filters):
	...
	return artech_engine.db.sql(sql_query, filters, as_dict=1)
