...
from artech.selling.report.sales_person_target_variance_based_on_item_group.sales_person_target_variance_based_on_item_group import (
	execute,
)
from artech.tests.utils import ArtechTestSuite


class TestSalesPersonTargetVarianceBasedOnItemGroup(ArtechTestSuite):
	def setUp(self):
...
def create_target_distribution(fiscal_year):
	distribution = artech_engine.new_doc("Monthly Distribution")
...
def create_sales_target_doc(
	...
	sales_target_doc = artech_engine.new_doc(sales_field_dt)
