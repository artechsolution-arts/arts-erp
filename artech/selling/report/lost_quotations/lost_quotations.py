...
from artech_engine.query_builder.functions import Coalesce, Count, Round, Sum
from artech_engine.utils.data import get_timespan_date_range
...
def get_data(company: str, from_date: str, to_date: str, group_by: Literal["Lost Reason", "Competitor"]):
	...
	if group_by == "Lost Reason":
		...
		dimension = artech_engine.qb.DocType("Quotation Lost Reason Detail")
	elif group_by == "Competitor":
		fieldname = "competitor"
		dimension = artech_engine.qb.DocType("Competitor Detail")
	else:
		artech_engine.throw(_("Invalid Group By"))

	q = artech_engine.qb.DocType("Quotation")
