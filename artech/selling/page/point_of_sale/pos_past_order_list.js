artech.PointOfSale.PastOrderList = class {
	...
	make_filter_section() {
		...
		this.status_field = artech_engine.ui.form.make_control({
			df: {
	...
	refresh_list() {
		...
		return artech_engine.call({
			method: "artech.selling.page.point_of_sale.point_of_sale.get_past_order_list",
			freeze: true,
			...
			invoice.doctype
				...
				<div class="invoice-name-customer">
					<div class="invoice-customer">
						...
						${artech_engine.ellipsis(invoice.customer_name, 20)}
					</div>
