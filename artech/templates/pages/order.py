...
def get_context(context):
	...
	context.payment_ref = artech_engine.db.get_value(
		"Payment Request", {"reference_name": artech_engine.form_dict.name}, "name"
	)
	...
	if context.doc.get("customer"):
		...
		customer_loyalty_program = artech_engine.db.get_value("Customer", context.doc.customer, "loyalty_program")
	...
	if context.doc.get("supplier"):
		...
		context.show_make_pi_button = artech_engine.has_permission("Purchase Invoice", "create")
...
def get_payment_details(doc):
	show_pay_button, amount = (
		(
			"payments" in artech_engine.get_installed_apps()
			and artech_engine.db.get_single_value("Buying Settings", "show_pay_button")
