...
def execute():
	...
	finance_books = artech_engine.db.get_all("Finance Book", pluck="name")
...
def correct_value_for_assets_with_manual_depr_entries():
	...
	artech_engine.qb.update(asset).join(asset_details_and_depr_amount_map).on(
