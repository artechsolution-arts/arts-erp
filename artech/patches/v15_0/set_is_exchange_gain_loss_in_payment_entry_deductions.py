...
def execute():
	default_exchange_gain_loss_accounts = artech_engine.get_all(
		"Company",
	...
	payment_entry_deduction = artech_engine.qb.DocType("Payment Entry Deduction")

	artech_engine.qb.update(payment_entry_deduction).set(payment_entry_deduction.is_exchange_gain_loss, 1).join(
		payment_entry,
