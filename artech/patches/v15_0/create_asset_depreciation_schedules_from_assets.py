...
def get_asset_finance_books_map():
	...
	asset_finance_books_map = artech_engine._dict()
	for d in records:
...
def get_asset_depreciation_schedules_map():
	...
	asset_depreciation_schedules_map = artech_engine._dict()
	for d in records:
