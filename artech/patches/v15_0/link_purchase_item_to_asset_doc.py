...
def execute():
	if artech_engine.db.has_column("Asset", "purchase_invoice_item") and artech_engine.db.has_column(
		...
		for asset in assets:
			...
			if asset.purchase_invoice and not asset.purchase_invoice_item:
				...
				artech_engine.db.set_value("Asset", asset.name, "purchase_invoice_item", purchase_invoice_item)
			...
			if asset.purchase_receipt and not asset.purchase_receipt_item:
				...
				artech_engine.db.set_value("Asset", asset.name, "purchase_receipt_item", purchase_receipt_item)
