...
from artech_engine.model.naming import _generate_random_string
...
def execute():
	...
	"""
	artech_engine.db.truncate(DOCTYPE)
...
def bulk_insert_advance_entries(entries):
	...
	artech_engine.db.bulk_insert(DOCTYPE, fields=FIELDS, values=details)
