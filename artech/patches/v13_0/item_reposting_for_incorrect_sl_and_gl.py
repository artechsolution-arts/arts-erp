...
from artech_engine.utils import get_time, getdate, today

from artech.accounts.utils import update_gl_entries_after
from artech.stock.stock_ledger import update_entries_after
...
def execute():
	...
	for module, doctype in doctypes_to_reload:
		artech_engine.reload_doc(module, "doctype", doctype)
	...
	artech_engine.flags.warehouse_account_map = {}
	...
	if data:
		for row in artech_engine.get_all("Company", filters={"enable_perpetual_inventory": 1}):
