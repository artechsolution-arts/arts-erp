...
from artech.accounts.doctype.account.chart_of_accounts.chart_of_accounts import get_chart_metadata_fields
from artech.accounts.doctype.account.chart_of_accounts.verified import standard_chart_of_accounts
...
def update_account_categories():
	...
	companies = artech_engine.get_all("Company", pluck="name")
	...
	artech_engine.db.bulk_update("Account", mapped_account_categories)
