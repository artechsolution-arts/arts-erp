...
def set_series(doctype, value):
	doc = artech_engine.db.exists("Property Setter", {"doc_type": doctype, "property": "autoname"})
	if doc:
		artech_engine.db.set_value("Property Setter", doc, "value", value)
	else:
...
def get_series_to_preserve(doctype):
	series_to_preserve = artech_engine.db.get_value("DocType", doctype, "autoname")
