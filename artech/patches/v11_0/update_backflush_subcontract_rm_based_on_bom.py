...
def execute():
	...
	artech_engine.db.set_single_value("Buying Settings", "backflush_raw_materials_of_subcontract_based_on", "BOM")

	artech_engine.reload_doc("stock", "doctype", "stock_entry_detail")
