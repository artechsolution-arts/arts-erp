...
from artech_engine.query_builder import CustomFunction
from artech_engine.query_builder.custom import ConstantColumn
from artech_engine.query_builder.functions import Count, IfNull
...
def get_columns():
	...
	if artech_engine.db.has_column("Payment Ledger Entry", "remarks"):
...
def execute():
	...
	if artech_engine.reload_doc("accounts", "doctype", "payment_ledger_entry"):
