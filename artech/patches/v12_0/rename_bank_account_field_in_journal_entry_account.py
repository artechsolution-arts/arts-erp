...
def execute():
	...
	if not artech_engine.get_meta("Journal Entry Account").has_field("bank_account"):
		artech_engine.reload_doc("Accounts", "doctype", "Journal Entry Account")
...
def update_journal_entry_account_fieldname():
	...
	if artech_engine.db.has_column("Journal Entry Account", "bank_account_no"):
