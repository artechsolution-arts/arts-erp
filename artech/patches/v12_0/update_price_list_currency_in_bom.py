...
def execute():
	artech_engine.reload_doc("manufacturing", "doctype", "bom")
	artech_engine.reload_doc("manufacturing", "doctype", "bom_item")
	...
	for d in artech_engine.db.sql(
		...
		artech_engine.db.set_value("BOM", d.name, "plc_conversion_rate", plc_conversion_rate)
