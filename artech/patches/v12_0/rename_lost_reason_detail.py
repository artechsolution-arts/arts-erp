...
def execute():
	if artech_engine.db.exists("DocType", "Lost Reason Detail"):
		artech_engine.reload_doc("crm", "doctype", "opportunity_lost_reason")
		artech_engine.reload_doc("crm", "doctype", "opportunity_lost_reason_detail")
		artech_engine.reload_doc("setup", "doctype", "quotation_lost_reason_detail")
		...
		artech_engine.delete_doc("DocType", "Lost Reason Detail")
