...
artech_engine.ui.form.on("Asset Depreciation Schedule", {
	onload: function (frm) {
...
artech_engine.ui.form.on("Depreciation Schedule", {
	make_depreciation_entry: function (frm, cdt, cdn) {
		var row = locals[cdt][cdn];
		if (!row.journal_entry) {
			artech_engine.call({
				method: "artech.assets.doctype.asset.depreciation.make_depreciation_entry",
				args: {
	...
	depreciation_amount: function (frm, cdt, cdn) {
		artech.asset.set_accumulated_depreciation(frm);
	},
});

artech.asset.set_accumulated_depreciation = function (frm) {
