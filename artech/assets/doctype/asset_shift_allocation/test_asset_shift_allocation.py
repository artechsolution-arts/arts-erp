...
class TestAssetShiftAllocation(ArtechTestSuite):
	def setUp(self):
	...
	def test_asset_shift_allocation(self):
		...
		asset_shift_allocation = artech_engine.get_doc(
		...
		asset_shift_allocation = artech_engine.get_doc("Asset Shift Allocation", asset_shift_allocation.name)
...
def create_asset_shift_factors():
	...
	for s in shifts:
		artech_engine.get_doc(s).insert()
