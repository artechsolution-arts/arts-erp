...
from artech_engine.utils import add_days, cstr, get_last_day, getdate, nowdate
...
class TestAssetValueAdjustment(ArtechTestSuite):
	def setUp(self):
	...
	def test_current_asset_value(self):
		...
		asset_doc = artech_engine.get_doc("Asset", asset_name)
