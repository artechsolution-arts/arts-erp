...
from artech_engine.utils import cstr, flt, formatdate, get_link_to_form, getdate
...
from artech.assets.doctype.asset.depreciation import get_depreciation_accounts
...
class AssetValueAdjustment(Document):
	...
	def validate_date(self):
		asset_purchase_date = artech_engine.db.get_value("Asset", self.asset, "purchase_date")
	...
	def cancel_asset_revaluation_entry(self):
		...
		revaluation_entry = artech_engine.get_doc("Journal Entry", self.journal_entry)
...
def get_value_of_accounting_dimensions(asset_name: str):
	dimension_fields = [*artech_engine.get_list("Accounting Dimension", pluck="fieldname"), "cost_center"]
	return artech_engine.db.get_value("Asset", asset_name, fieldname=dimension_fields, as_dict=True)
