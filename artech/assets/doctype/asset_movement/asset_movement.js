...
artech_engine.ui.form.on("Asset Movement", {
	setup: (frm) => {
...
artech_engine.ui.form.on("Asset Movement Item", {
			...
			artech_engine.db
				...
				.then((asset_doc) => {
					if (asset_doc.location)
						artech_engine.model.set_value(cdt, cdn, "source_location", asset_doc.location);
					if (asset_doc.custodian)
						artech_engine.model.set_value(cdt, cdn, "from_employee", asset_doc.custodian);
				})
				.catch((err) => {
