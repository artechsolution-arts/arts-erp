...
# Embedded file name: /Users/anuragmishra/artech_engine-develop/apps/artech/artech/buying/report/subcontracted_raw_materials_to_be_transferred/test_subcontracted_raw_materials_to_be_transferred.py
# Compiled at: 2019-05-06 10:24:35
# Decompiled by https://python-decompiler.com

import artech_engine

from artech.buying.report.subcontracted_raw_materials_to_be_transferred.subcontracted_raw_materials_to_be_transferred import (
	execute,
)
...
class TestSubcontractedItemToBeTransferred(ArtechTestSuite):
			...
			filters=artech_engine._dict(
				{
					...
					"from_date": artech_engine.utils.get_datetime(
						artech_engine.utils.add_to_date(sco.transaction_date, days=-10)
					),
					"to_date": artech_engine.utils.get_datetime(
						artech_engine.utils.add_to_date(sco.transaction_date, days=10)
					),
				}
			)
