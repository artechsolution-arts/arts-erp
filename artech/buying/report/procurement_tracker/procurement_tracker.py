...
def get_mapped_mr_details(filters):
	mr_records = {}
	parent = artech_engine.qb.DocType("Material Request")
	child = artech_engine.qb.DocType("Material Request Item")
	...
	for record in mr_details:
		if record.per_ordered:
			mr_records.setdefault(record.name, []).append(artech_engine._dict(record))
		else:
...
def get_mapped_pi_records():
	...
	return artech_engine._dict(pi_records)
...
def get_mapped_pr_records():
	...
	return artech_engine._dict(pr_records)


def get_po_entries(filters):
	parent = artech_engine.qb.DocType("Purchase Order")
	child = artech_engine.qb.DocType("Purchase Order Item")
