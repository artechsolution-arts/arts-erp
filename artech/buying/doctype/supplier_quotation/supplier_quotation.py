...
from artech_engine.utils import flt, getdate, nowdate
...
class SupplierQuotation(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from artech.buying.doctype.supplier_quotation_item.supplier_quotation_item import (
	...
	def set_has_unit_price_items(self):
		...
		"""
		if not artech_engine.db.get_single_value("Buying Settings", "allow_zero_qty_in_supplier_quotation"):
			return
	...
	def update_rfq_supplier_status(self, include_me):
		...
		for rfq in rfq_list:
			doc = artech_engine.get_doc("Request for Quotation", rfq)
			doc_sup = artech_engine.get_all(
	...
	doclist = get_mapped_doc(
		...
		source_name,
		{
			...
			"Supplier Quotation Item": {
				...
				"condition": lambda doc: artech_engine.db.get_value("Item", doc.item_code, "is_sales_item") == 1,
				"add_if_empty": True,
			},
		},
		target_doc,
