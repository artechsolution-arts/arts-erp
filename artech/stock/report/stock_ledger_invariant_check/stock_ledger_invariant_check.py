...
from artech_engine.utils import cint, flt, get_link_to_form, parse_json
...
def add_invariant_check_fields(sles, filters):
	...
	for idx, sle in enumerate(sles):
		...
		if (
			...
			balance_qty = artech_engine.db.get_value("Stock Reconciliation Item", sle.voucher_detail_no, "qty")
		...
		if sle.batch_no:
			sle.use_batchwise_valuation = artech_engine.db.get_value(
