...
def get_landed_cost_vouchers(filters):
	lcv = artech_engine.qb.DocType("Landed Cost Voucher")
	lcv_voucher = artech_engine.qb.DocType("Landed Cost Purchase Receipt")

	query = (
		artech_engine.qb.from_(lcv)
...
def get_vendor_invoices(landed_vouchers):
	doctype = artech_engine.qb.DocType("Landed Cost Vendor Invoice")
