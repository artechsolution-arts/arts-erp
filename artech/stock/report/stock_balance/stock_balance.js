...
artech_engine.query_reports["Stock Balance"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
		...
		},
		{
			...
			get_data: async function (txt) {
				let item_group = artech_engine.query_report.get_filter_value("item_group");
		...
		},
		{
			...
			get_data: (txt) => {
				...
				return artech_engine.db.get_link_options("Warehouse", txt, filters);
			},
		},
		{
	...
	onload: function (report) {
		report.page.add_inner_button(__("View Stock Ledger"), function () {
			...
			artech_engine.set_route("query-report", "Stock Ledger", filters);
		});
	},
};

artech.utils.add_inventory_dimensions("Stock Balance", 8);
