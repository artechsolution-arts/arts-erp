...
class TestStockBalance(ArtechTestSuite):
	# ----------- utils
	...
	def assertInvariants(self, rows):
		last_balance = artech_engine.db.sql(
			"""
	...
	@ArtechTestSuite.change_settings("System Settings", {"float_precision": 3, "currency_precision": 3})
