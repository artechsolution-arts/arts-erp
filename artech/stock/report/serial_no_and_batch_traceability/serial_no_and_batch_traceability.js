artech_engine.query_reports["Serial No and Batch Traceability"] = {
	filters: [
		{
			fieldname: "item_code",
			label: __("Item Code"),
		...
		},
		{
			...
			get_data: (txt) => {
				...
				return artech_engine.db.get_link_options("Batch", txt, filters);
			},
		},
		{
			...
			get_data: (txt) => {
				...
				return artech_engine.db.get_link_options("Serial No", txt, filters);
			},
		},
		{
...
function custom_formatter(value, row, column, data, default_formatter) {
	...
	let filter_values = {
		batch_no: artech_engine.query_report.get_filter_value("batches"),
		serial_no: artech_engine.query_report.get_filter_value("serial_nos"),
	};
	let item_code = artech_engine.query_report.get_filter_value("item_code");
