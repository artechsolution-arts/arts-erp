...
from artech.stock.report.stock_analytics.stock_analytics import execute, get_period_date_ranges
...
class TestStockAnalyticsReport(ArtechTestSuite):
	def setUp(self) -> None:
	...
	def assert_single_item_report(self, movement, expected_buckets):
		...
		row = artech_engine._dict(data[0])
