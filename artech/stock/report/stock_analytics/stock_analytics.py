...
from artech_engine.utils import get_datetime, get_first_day_of_week, get_quarter_start, getdate
from artech_engine.utils import get_first_day as get_first_day_of_month
...
def get_items(filters):
	...
	if item_code := filters.get("item_code"):
		...
		return artech_engine.get_all("Item", filters=item_filters, pluck="name", order_by=None)
