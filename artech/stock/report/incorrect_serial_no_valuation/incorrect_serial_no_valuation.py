...
def get_bundles(data):
	...
	bundle_dict = artech_engine._dict()
	serial_nos_data = artech_engine.get_all(
...
def get_incorrect_serial_nos(serial_nos_data):
	...
	total_value = artech_engine._dict({"qty": 0, "valuation_rate": 0, "serial_no": artech_engine.bold(_("Balance"))})

	for _serial_no, data in serial_nos_data.items():
		total_dict = artech_engine._dict({"qty": 0, "valuation_rate": 0, "serial_no": artech_engine.bold(_("Total"))})
