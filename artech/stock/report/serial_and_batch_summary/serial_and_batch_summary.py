...
def get_voucher_type(doctype: Any, txt: str, searchfield: Any, start: int, page_len: int, filters: dict):
	...
	return artech_engine.get_all("DocField", filters=query_filters, fields=["parent"], as_list=True, distinct=True)
...
def get_serial_nos(doctype: Any, txt: str, searchfield: Any, start: int, page_len: int, filters: dict):
	...
	if filters.get("voucher_no"):
		serial_batch_bundle = artech_engine.get_cached_value(
			"Serial and Batch Bundle",
		...
		return artech_engine.get_all("Serial No", filters=query_filters, as_list=True)
...
def get_batch_nos(doctype: Any, txt: str, searchfield: Any, start: int, page_len: int, filters: dict):
	...
	if filters.get("voucher_no"):
		...
		return artech_engine.get_all("Batch", filters=query_filters, as_list=True)
