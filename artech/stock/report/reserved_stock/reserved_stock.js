...
artech_engine.query_reports["Reserved Stock"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
		...
		},
		{
			...
			get_options: function () {
				return artech_engine.query_report.get_filter_value("voucher_type");
			},
		},
		{
		...
		},
		{
			...
			get_options: function () {
				return artech_engine.query_report.get_filter_value("from_voucher_type");
			},
		},
		{
