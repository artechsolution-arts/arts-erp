...
from artech.stock.report.stock_ledger_invariant_check.stock_ledger_invariant_check import (
...
def get_data(filters=None):
	...
	valuation_method = artech_engine.get_cached_value("Company", filters.get("company"), "valuation_method")
