...
def update_batch_qty(selected_batches: str | None = None):
	artech_engine.has_permission("Batch", "write", throw=True, ignore_share_permissions=True)
	...
	for row in selected_batches:
		...
		artech_engine.db.set_value("Batch", batch_name, "batch_qty", batch_qty)

	artech_engine.msgprint(_("Batch Qty updated successfully"), alert=True)
