artech_engine.pages["warehouse-capacity-summary"].on_page_load = function (wrapper) {
	...
	artech_engine.require("item-dashboard.bundle.js", function () {
		$(artech_engine.render_template("warehouse_capacity_summary_header")).appendTo(page.main);

		page.capacity_dashboard = new artech.stock.ItemDashboard({
			page_name: "warehouse-capacity-summary",
			page_length: 10,
			parent: page.main,
			sort_by: "stock_capacity",
			sort_order: "desc",
			method: "artech.stock.dashboard.warehouse_capacity_dashboard.get_data",
