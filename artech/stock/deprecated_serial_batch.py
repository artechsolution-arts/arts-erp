...
class DeprecatedSerialNoValuation:
	@deprecated(
		"artech.stock.serial_batch_bundle.SerialNoValuation.calculate_stock_value_from_deprecarated_ledgers",
		"unknown",
		"v16",
	...
	@deprecated(
		"artech.stock.serial_batch_bundle.SerialNoValuation.get_incoming_value_for_serial_nos",
		"unknown",
		"v16",
		"No known instructions.",
	)
	def get_incoming_value_for_serial_nos(self, serial_nos):
		...
		for serial_no in serial_nos:
			sn_details = artech_engine.db.get_value("Serial No", serial_no, ["purchase_rate", "company"], as_dict=1)
...
class DeprecatedBatchNoValuation:
	@deprecated(
		"artech.stock.serial_batch_bundle.BatchNoValuation.calculate_avg_rate_from_deprecarated_ledgers",
		"unknown",
		"v16",
		"No known instructions.",
	)
	...
	@deprecated(
		"artech.stock.serial_batch_bundle.BatchNoValuation.get_sle_for_batches",
		"unknown",
		"v16",
		"No known instructions.",
	)
	...
	@deprecated(
		"artech.stock.serial_batch_bundle.BatchNoValuation.calculate_avg_rate_for_non_batchwise_valuation",
		"unknown",
		"v16",
		"No known instructions.",
	)
	...
	@deprecated(
		"artech.stock.serial_batch_bundle.BatchNoValuation.set_balance_value_for_non_batchwise_valuation_batches",
		"unknown",
		"v16",
		"No known instructions.",
	)
	...
	@deprecated(
		"artech.stock.serial_batch_bundle.BatchNoValuation.set_balance_value_from_sl_entries",
		"unknown",
		"v16",
		"No known instructions.",
	)
	def set_balance_value_from_sl_entries(self) -> None:
		...
		if valuation_method := self.get_valuation_method(self.sle.item_code):
			if valuation_method == "Moving Average" and not artech_engine.db.get_single_value(
	...
	def get_last_sle_for_non_batch(self):
		...
		return data[0] if data else artech_engine._dict()

	@deprecated(
		"artech.stock.serial_batch_bundle.BatchNoValuation.set_balance_value_from_bundle",
		"unknown",
		"v16",
		"No known instructions.",
	)
	def set_balance_value_from_bundle(self) -> None:
		...
		bundle = artech_engine.qb.DocType("Serial and Batch Bundle")
