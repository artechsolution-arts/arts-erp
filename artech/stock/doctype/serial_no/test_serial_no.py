...
class TestSerialNo(ArtechTestSuite):
	def setUp(self):
		self.load_test_records("Stock Entry")

	def test_cannot_create_direct(self):
		artech_engine.delete_doc_if_exists("Serial No", "_TCSER0001")

		sr = artech_engine.new_doc("Serial No")
	...
	def test_inter_company_transfer(self):
		...
		serial_no = artech_engine.get_doc("Serial No", serial_nos[0])
	...
	def test_inter_company_transfer_intermediate_cancellation(self):
		...
		sn_doc = artech_engine.get_doc("Serial No", serial_nos[0])
		...
		self.assertRaises(artech_engine.ValidationError, dn.cancel)
		...
		self.assertRaises(artech_engine.ValidationError, se.cancel)
		self.assertRaises(artech_engine.ValidationError, dn.cancel)
		self.assertRaises(artech_engine.ValidationError, pr.cancel)
	...
	def test_auto_fetch(self):
		...
		# expiry date
		artech_engine.db.set_value("Batch", batch1, "expiry_date", "1980-01-01")
