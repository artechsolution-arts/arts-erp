...
from artech_engine.utils import add_to_date, nowdate
...
def create_product_bundle(
	...
	bundle_doc = artech_engine.get_doc({"doctype": "Product Bundle", "new_item_code": bundle})
...
class TestPackedItem(ArtechTestSuite):
