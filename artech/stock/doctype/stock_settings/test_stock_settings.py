...
class TestStockSettings(ArtechTestSuite):
	def setUp(self):
		super().setUp()
		artech_engine.db.set_single_value("Stock Settings", "clean_description_html", 0)
	...
	def test_settings(self):
		...
		settings = artech_engine.get_single("Stock Settings")
