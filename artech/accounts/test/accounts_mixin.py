...
class AccountsTestMixin:
	def create_customer(
		...
		if not artech_engine.db.exists("Customer", customer_name):
			...
			if company and default_account:
				customer = artech_engine.get_doc("Customer", customer_name)
				customer.accounts = []
				customer.append(
					"accounts",
					{
	...
	def create_company(self, company_name="_Test Company", abbr="_TC"):
		...
		for acc in other_accounts:
			...
			if artech_engine.db.exists("Account", acc_name):
				setattr(self, acc.attribute_name, acc_name)
			else:
				new_acc = artech_engine.get_doc(
					{
						"doctype": "Account",
	...
	def identify_default_warehouses(self):
		for w in artech_engine.db.get_all(
