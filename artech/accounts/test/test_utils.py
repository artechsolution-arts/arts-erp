...
from artech.accounts.party import get_party_shipping_address
...
class TestUtils(ArtechTestSuite):
	...
	def test_update_reference_in_payment_entry(self):
		...
		payment_reconciliation = artech_engine.new_doc("Payment Reconciliation")
	...
	def test_naming_series_variable_parsing(self):
		...
		artech_engine.db.set_default("supp_master_name", "Auto Name")
		...
		artech_engine.db.set_default("supp_master_name", "Supplier Name")
