...
from artech_engine.utils import nowdate, today
...
# On ArtechTestSuite, the doctype test records and all
# link-field test record depdendencies are recursively loaded
# Use these module variables to add/remove to/from that list
from artech.tests.utils import ArtechTestSuite


class TestAdvancePaymentLedgerEntry(ArtechTestSuite, AccountsTestMixin):
	"""
