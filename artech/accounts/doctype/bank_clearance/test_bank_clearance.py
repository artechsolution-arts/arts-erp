...
from artech_engine.utils import add_months, getdate
...
from artech.tests.utils import ArtechTestSuite, if_lending_app_installed, if_lending_app_not_installed


class TestBankClearance(ArtechTestSuite):
	def setUp(self):
	...
	def test_bank_clearance(self):
		bank_clearance = artech_engine.get_doc("Bank Clearance")
	...
	def test_update_clearance_date_on_si(self):
		...
		si_clearance_date = artech_engine.db.get_value(
...
def make_bank_account():
	if not artech_engine.db.get_value("Account", "_Test Bank Clearance - _TC"):
...
def make_pos_sales_invoice():
	...
	mode_of_payment = artech_engine.get_doc({"doctype": "Mode of Payment", "name": "Cash"})

	if not artech_engine.db.get_value("Mode of Payment Account", {"company": "_Test Company", "parent": "Cash"}):
	...
	mode_of_payment = artech_engine.get_doc("Mode of Payment", "Wire Transfer")
