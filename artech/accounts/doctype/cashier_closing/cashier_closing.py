...
class CashierClosing(Document):
	...
	if TYPE_CHECKING:
		...
		from artech.accounts.doctype.cashier_closing_payments.cashier_closing_payments import (
	...
	def validate_time(self):
		if self.from_time >= self.time:
			artech_engine.throw(_("From Time Should Be Less Than To Time"))
