artech_engine.ui.form.on("Accounts Settings", {
	refresh: function (frm) {
		frm.set_query("document_type", "repost_allowed_types", function (doc, cdt, cdn) {
			return {
				filters: {
					name: ["in", artech_engine.boot.sysdefaults.repost_allowed_doctypes],
				},
			};
		});
	},
	...
	drop_ar_procedures: function (frm) {
		frm.call({
			...
			callback: function (r) {
				artech_engine.show_alert(__("Procedures dropped"), 5);
			},
		});
	},
});
