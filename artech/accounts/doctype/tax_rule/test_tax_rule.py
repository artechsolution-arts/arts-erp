...
from artech.accounts.doctype.tax_rule.tax_rule import ConflictingTaxRule, get_tax_template
...
class TestTaxRule(ArtechTestSuite):
	def setUp(self):
		artech_engine.db.set_single_value("Shopping Cart Settings", "enabled", 0)
