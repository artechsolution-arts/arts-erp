...
class TestAccountingDimension(ArtechTestSuite):
	def test_dimension_against_sales_invoice(self):
		...
		gle = artech_engine.get_doc("GL Entry", {"voucher_no": si.name, "account": "Sales - _TC"})
	...
	def test_dimension_against_journal_entry(self):
		...
		gle = artech_engine.get_doc("GL Entry", {"voucher_no": je.name, "account": "Sales - _TC"})
		gle1 = artech_engine.get_doc("GL Entry", {"voucher_no": je.name, "account": "Sales Expenses - _TC"})
		self.assertEqual(gle.get("department"), "_Test Department - _TC")
