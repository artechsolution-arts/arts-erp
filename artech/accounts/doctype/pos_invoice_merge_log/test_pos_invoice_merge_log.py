...
class TestPOSInvoiceMergeLog(ArtechTestSuite):
	def setUp(self):
	...
	def test_consolidated_invoice_creation(self):
		...
		self.assertTrue(artech_engine.db.exists("Sales Invoice", pos_inv.consolidated_invoice))

		pos_inv3.load_from_db()
		self.assertTrue(artech_engine.db.exists("Sales Invoice", pos_inv3.consolidated_invoice))
	...
	def test_consolidated_credit_note_creation(self):
		...
		self.assertTrue(artech_engine.db.exists("Sales Invoice", pos_inv_cn.consolidated_invoice))
		consolidated_credit_note = artech_engine.get_doc("Sales Invoice", pos_inv_cn.consolidated_invoice)
	...
	def test_consolidated_invoice_item_taxes(self):
		...
		consolidated_invoice = artech_engine.get_doc("Sales Invoice", inv.consolidated_invoice)
	...
	def test_separate_consolidated_invoice_for_different_accounting_dimensions(self):
		...
		pos_inv2.load_from_db()
		self.assertTrue(artech_engine.db.exists("Sales Invoice", pos_inv2.consolidated_invoice))
	...
	def test_company_in_pos_invoice_merge_log(self):
		...
		self.assertTrue(artech_engine.db.exists("POS Invoice Merge Log", {"pos_closing_entry": closing_entry.name}))

		pos_merge_log_company = artech_engine.db.get_value(
