...
from artech.accounts.doctype.cost_center_allocation.cost_center_allocation import (
...
class TestCostCenterAllocation(ArtechTestSuite):
	def setUp(self):
		cost_centers = [
			"Main Cost Center 1",
			"Main Cost Center 2",
	...
	@ArtechTestSuite.change_settings("System Settings", {"rounding_method": "Commercial Rounding"})
...
def create_cost_center_allocation(
	...
	doc = artech_engine.new_doc("Cost Center Allocation")
