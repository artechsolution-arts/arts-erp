...
class TestProcessDeferredAccounting(ArtechTestSuite):
	def test_creation_of_ledger_entry_on_submit(self):
		...
		process_deferred_accounting = artech_engine.get_doc(
...
def change_acc_settings(
	...
	artech_engine.db.set_value("Company", company, "accounts_frozen_till_date", acc_frozen_till_date)
	acc_settings.save()
