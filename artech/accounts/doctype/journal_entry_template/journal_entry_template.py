...
class JournalEntryTemplate(Document):
	...
	if TYPE_CHECKING:
		...
		from artech.accounts.doctype.journal_entry_template_account.journal_entry_template_account import (
	...
	def validate_party(self):
		...
		for account in self.accounts:
			if account.party_type:
				account_type = artech_engine.get_cached_value("Account", account.account, "account_type")
...
def get_naming_series():
	return artech_engine.get_meta("Journal Entry").get_field("naming_series").options
