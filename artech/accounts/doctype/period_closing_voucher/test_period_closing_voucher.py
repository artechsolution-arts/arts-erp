...
from artech.accounts.doctype.finance_book.test_finance_book import create_finance_book
...
class TestPeriodClosingVoucher(ArtechTestSuite):
	def setUp(self):
		super().setUp()
	...
	def test_gl_entries_restrictions(self):
		...
		self.assertRaises(artech_engine.ValidationError, jv1.submit)
	...
	def test_closing_balance_with_dimensions_and_test_reposting_entry(self):
		...
		closing_balance = artech_engine.db.get_value(
		...
		cc1_closing_balance = artech_engine.db.get_value(
			"Account Closing Balance",
			{
				"account": "Sales - TPC",
				"cost_center": cost_center1,
		...
		cc2_closing_balance = artech_engine.db.get_value(
			"Account Closing Balance",
			{
				"account": "Sales - TPC",
				"cost_center": cost_center2,
		...
		warehouse = artech_engine.db.get_value("Warehouse", {"company": company}, "name")
...
def create_cost_center(cc_name):
	costcenter = artech_engine.get_doc(
		{
			"company": "Test PCV Company",
