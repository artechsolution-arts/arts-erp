...
class AutoMatchParty:
	...
	def match(self) -> tuple | None:
		...
		fuzzy_matching_enabled = artech_engine.get_single_value("Accounts Settings", "enable_fuzzy_matching")
...
class AutoMatchbyAccountIBAN:
	...
	def match_account_in_party(self) -> tuple | None:
		...
		party_result = artech_engine.db.get_all(
			"Bank Account",
		...
		if employee_result := artech_engine.db.get_all(
...
class AutoMatchbyPartyNameDescription:
	...
	def match_party_name_desc_in_party(self) -> tuple | None:
		...
		for party in parties:
			...
			names = artech_engine.get_all(party, filters=filters, fields=[f"{field} as party_name", "name"])
