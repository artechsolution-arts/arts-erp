...
class TestBankTransactionFees(ArtechTestSuite):
	def test_included_fee_throws(self):
		"""A fee that's part of a withdrawal cannot be bigger than the
		withdrawal itself."""
		bt = artech_engine.new_doc("Bank Transaction")
		bt.withdrawal = 100
		bt.included_fee = 101

		self.assertRaises(artech_engine.ValidationError, bt.validate_included_fee)
	...
	def test_excluded_fee_throws_when_exceeds_deposit(self):
		...
		self.assertRaises(artech_engine.ValidationError, bt.handle_excluded_fee)
