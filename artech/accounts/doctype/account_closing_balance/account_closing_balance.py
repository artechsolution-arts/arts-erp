...
from artech.exceptions import ReportingCurrencyExchangeNotFoundError
...
def make_closing_entries(closing_entries, voucher_name, company, closing_date):
	...
	for _key, value in merged_entries.items():
		cle = artech_engine.new_doc("Account Closing Balance")
		cle.update(value)
...
def get_previous_closing_entries(company, closing_date, accounting_dimensions):
	...
	if last_period_closing_voucher:
		account_closing_balance = artech_engine.qb.DocType("Account Closing Balance")
		query = artech_engine.qb.from_(account_closing_balance).select(
