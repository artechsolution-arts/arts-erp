...
from artech.accounts.report.payment_ledger.payment_ledger import execute
from artech.tests.utils import ArtechTestSuite


class TestPaymentLedger(ArtechTestSuite):
	def setUp(self):
		self.create_company()
		self.cleanup()
	...
	def create_company(self):
		...
		if artech_engine.db.exists("Company", name):
			company = artech_engine.get_doc("Company", name)
		else:
