...
from artech.accounts.party import get_partywise_advanced_payment_amount
from artech.accounts.report.accounts_receivable.accounts_receivable import ReceivablePayableReport
from artech.accounts.utils import get_currency_precision, get_party_types_from_account_type
...
class AccountsReceivableSummary(ReceivablePayableReport):
	...
	def get_data(self, args):
		...
		for party, party_dict in self.party_total.items():
			...
			if self.party_naming_by == "Naming Series":
				...
				row.party_name = artech_engine.get_cached_value(doctype, party, fieldname)
	...
	def get_party_total(self, args):
		self.party_total = artech_engine._dict()
	...
	def init_party_total(self, row):
		...
		self.party_total.setdefault(
			row.party,
			artech_engine._dict(default_dict),
		)
