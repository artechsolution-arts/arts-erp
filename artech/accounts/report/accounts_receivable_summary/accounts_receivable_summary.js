...
artech_engine.query_reports["Accounts Receivable Summary"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
	...
	onload: function (report) {
		report.page.add_inner_button(__("Accounts Receivable"), function () {
			...
			artech_engine.set_route("query-report", "Accounts Receivable", { company: filters.company });
		});
...
artech.utils.add_dimensions("Accounts Receivable Summary", 9);
