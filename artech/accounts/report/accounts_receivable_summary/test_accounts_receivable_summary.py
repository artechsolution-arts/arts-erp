...
from artech.accounts.report.accounts_receivable_summary.accounts_receivable_summary import execute
...
class TestAccountsReceivable(ArtechTestSuite, AccountsTestMixin):
	...
	def test_01_receivable_summary_output(self):
		...
		customer_group, customer_territory = artech_engine.db.get_all(
			"Customer",
	...
	@ArtechTestSuite.change_settings("Selling Settings", {"cust_master_name": "Naming Series"})
