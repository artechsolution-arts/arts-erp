...
def execute(filters=None):
	...
	account_currency = artech_engine.get_cached_value("Account", filters.account, "account_currency")
...
def get_entries(filters):
	...
	for method_name in artech_engine.get_hooks("get_entries_for_bank_reconciliation_statement"):
		entries += artech_engine.get_attr(method_name)(filters) or []
...
def get_amounts_not_reflected_in_system(filters):
	...
	for method_name in artech_engine.get_hooks(
		"get_amounts_not_reflected_in_system_for_bank_reconciliation_statement"
	):
		amount += artech_engine.get_attr(method_name)(filters) or 0.0
