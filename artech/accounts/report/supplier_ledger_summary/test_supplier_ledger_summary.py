...
from artech.accounts.report.supplier_ledger_summary.supplier_ledger_summary import execute
from artech.accounts.test.accounts_mixin import AccountsTestMixin
from artech.tests.utils import ArtechTestSuite


class TestSupplierLedgerSummary(ArtechTestSuite, AccountsTestMixin):
	def setUp(self):
		self.create_company()
	...
	def test_supplier_ledger_summary_with_filters(self):
		...
		supplier_group = artech_engine.db.get_value("Supplier", self.supplier, "supplier_group")
