...
class TestGeneralLedger(ArtechTestSuite):
	...
	def test_foreign_account_balance_after_exchange_rate_revaluation(self):
		...
		revaluation = artech_engine.new_doc("Exchange Rate Revaluation")
	...
	def test_ignore_cr_dr_notes_filter(self):
		...
		system_generated_journal = artech_engine.db.get_all(
			"Journal Entry",
			filters={
				"docstatus": 1,
