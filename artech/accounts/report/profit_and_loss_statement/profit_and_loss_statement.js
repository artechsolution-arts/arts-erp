...
artech_engine.query_reports[PL_REPORT_NAME] = $.extend({}, artech.financial_statements);

artech.utils.add_dimensions(PL_REPORT_NAME, 10);

artech_engine.query_reports[PL_REPORT_NAME]["filters"].push(
	{
...
artech_engine.query_reports[PL_REPORT_NAME]["export_hidden_cols"] = true;
