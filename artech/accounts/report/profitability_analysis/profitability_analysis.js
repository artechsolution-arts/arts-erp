...
artech_engine.query_reports["Profitability Analysis"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
	...
	formatter: function (value, row, column, data, default_formatter) {
		if (column.fieldname == "account") {
			...
			column.link_onclick =
				"artech_engine.query_reports['Profitability Analysis'].open_profit_and_loss_statement(" +
				JSON.stringify(data) +
				")";
			column.is_tree = true;
		}
	...
	open_profit_and_loss_statement: function (data) {
		...
		if (data.based_on == "Cost Center") {
			artech_engine.route_options["cost_center"] = data.account;
		} else {
			artech_engine.route_options["project"] = data.account;
		}
