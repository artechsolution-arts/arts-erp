...
import artech
from artech.accounts.report.item_wise_sales_register.item_wise_sales_register import (
	add_sub_total_row,
	add_total_row,
...
def get_items(filters, additional_table_columns):
	...
	pii = artech_engine.qb.DocType("Purchase Invoice Item")
...
def get_aii_accounts():
	return dict(artech_engine.db.sql("select name, stock_received_but_not_billed from tabCompany"))


def get_purchase_receipts_against_purchase_order(item_list):
	po_pr_map = artech_engine._dict()
	po_item_rows = list(set(d.po_detail for d in item_list))

	if po_item_rows:
		purchase_receipts = artech_engine.db.sql(
			"""
