...
from artech.accounts.report.item_wise_purchase_register.item_wise_purchase_register import execute
from artech.accounts.test.accounts_mixin import AccountsTestMixin
from artech.tests.utils import ArtechTestSuite


class TestItemWisePurchaseRegister(ArtechTestSuite, AccountsTestMixin):
	def setUp(self):
		self.create_company()
