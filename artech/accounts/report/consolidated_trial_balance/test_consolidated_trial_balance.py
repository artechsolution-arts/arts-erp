...
from artech.accounts.report.consolidated_trial_balance.consolidated_trial_balance import execute
from artech.setup.utils import get_exchange_rate
from artech.tests.utils import ArtechTestSuite


class ForeignCurrencyTranslationReserveNotFoundError(artech_engine.ValidationError):
	pass


class TestConsolidatedTrialBalance(ArtechTestSuite):
	def setUp(self):
	...
	def test_single_company_report(self):
		filters = artech_engine._dict({"company": ["Parent Group Company India"], "fiscal_year": self.fiscal_year})
