...
from artech.accounts.report.balance_sheet.balance_sheet import execute
...
class TestBalanceSheet(ArtechTestSuite):
...
def create_account(account_name: str, parent_account: str, company: str):
	if artech_engine.db.exists("Account", {"account_name": account_name, "company": company}):
		return
