...
def execute(filters=None):
	...
	currency = filters.presentation_currency or artech_engine.get_cached_value(
...
def get_provisional_profit_loss(
	...
	if asset:
		...
		currency = currency or artech_engine.get_cached_value("Company", company, "default_currency")
		total_row = {
