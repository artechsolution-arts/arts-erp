...
from artech.accounts.report.customer_ledger_summary.customer_ledger_summary import execute
...
class TestCustomerLedgerSummary(ArtechTestSuite, AccountsTestMixin):
	def setUp(self):
		self.create_company()
