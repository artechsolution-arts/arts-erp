...
from artech_engine.utils import add_days, flt, formatdate
...
def get_asset_categories_for_grouped_by_category(filters):
	...
	asset_depreciation_schedule = artech_engine.qb.DocType("Asset Depreciation Schedule")
	asset_capitalization_asset_item = artech_engine.qb.DocType("Asset Capitalization Asset Item")
	asset_capitalization = artech_engine.qb.DocType("Asset Capitalization")
	...
	capitalized_before_from_date = (
		artech_engine.qb.from_(asset_capitalization_asset_item)
	...
	if filters.get("finance_book"):
		assets_with_finance_book = (
			artech_engine.qb.from_(asset_depreciation_schedule)
...
def get_assets_for_grouped_by_category(filters):
	...
	asset_category_account = artech_engine.qb.DocType("Asset Category Account")
