...
from artech.accounts.report.item_wise_sales_register.item_wise_sales_register import execute
...
class TestItemWiseSalesRegister(ArtechTestSuite, AccountsTestMixin):
	...
	def test_grouped_report_handles_different_tax_descriptions(self):
		...
		first_tax_amount_field = f"{artech_engine.scrub(first_tax_description)}_amount"
		second_tax_amount_field = f"{artech_engine.scrub(second_tax_description)}_amount"
