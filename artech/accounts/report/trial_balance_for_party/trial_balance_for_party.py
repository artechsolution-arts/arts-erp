...
from artech.accounts.report.general_ledger.general_ledger import get_accounts_with_children
...
def get_data(filters, show_party_name):
	if filters.get("party_type") in ("Customer", "Supplier", "Employee", "Member"):
		party_name_field = "{}_name".format(artech_engine.scrub(filters.get("party_type")))
...
def get_balances_within_period(filters, account_filter=None):
	...
	balances_within_period = artech_engine._dict()
	for d in gle:
...
def is_party_name_visible(filters):
	...
	if filters.get("party_type") in ["Customer", "Supplier"]:
		if filters.get("party_type") == "Customer":
			party_naming_by = artech_engine.get_single_value("Selling Settings", "cust_master_name")
		else:
			party_naming_by = artech_engine.db.get_single_value("Buying Settings", "supp_master_name")
