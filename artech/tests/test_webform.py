...
class TestWebsite(ArtechTestSuite):
...
def get_data():
	webform_list_contexts = artech_engine.get_hooks("webform_list_context")
	if webform_list_contexts:
		context = artech_engine._dict(artech_engine.get_attr(webform_list_contexts[0])("Buying") or {})
