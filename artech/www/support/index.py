...
def get_context(context):
	...
	setting = artech_engine.get_doc("Support Settings")
...
def get_favorite_articles(favorite_articles):
	...
	for article in favorite_articles:
		description = artech_engine.utils.strip_html(article.content)
...
def get_help_article_list():
	help_article_list = []
	category_list = artech_engine.get_all("Help Category", fields="name")
	for category in category_list:
		help_articles = artech_engine.get_all(
			"Help Article",
			fields="*",
