...
class TestTaxes(ArtechTestSuite):
	def setUp(self):
		self.company = artech_engine.get_doc(
			{
				"doctype": "Company",
				"company_name": uuid4(),
		...
		self.account = artech_engine.get_doc(
			{
				"doctype": "Account",
				"account_name": uuid4(),
				"account_type": "Tax",
		...
		self.item_group = artech_engine.get_doc(
			{
				"doctype": "Item Group",
		...
		self.item_tax_template = artech_engine.get_doc(
			{
		...
		self.item = artech_engine.get_doc(
			{
				"doctype": "Item",
				"item_code": uuid4(),
		...
		self.customer = artech_engine.get_doc(
			{
				"doctype": "Customer",
				"customer_name": uuid4(),
		...
		self.supplier = artech_engine.get_doc(
			{
				"doctype": "Supplier",
				"supplier_name": uuid4(),
			...
			doc = artech_engine.get_doc(
				{
					...
					"currency": "USD",
					"schedule_date": artech_engine.utils.nowdate(),
					"delivery_date": artech_engine.utils.nowdate(),
