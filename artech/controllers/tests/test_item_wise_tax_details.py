...
from artech.tests.utils import ArtechTestSuite, change_settings


class TestTaxesAndTotals(ArtechTestSuite):
	def setUp(self):
		self.doc = artech_engine.get_doc(
			{
	...
	def test_not_applicable_tax_in_item_tax_template(self):
		...
		template_7pct = artech_engine.get_doc(
			{
		...
		template_19pct = artech_engine.get_doc(
			{
				"doctype": "Item Tax Template",
