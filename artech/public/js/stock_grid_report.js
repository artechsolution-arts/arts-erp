...
artech.StockGridReport = class StockGridReport extends artech_engine.views.TreeGridReport {
	...
	get_serialized_buying_rates() {
		...
		if (artech_engine.report_dump.data["Serial No"]) {
			$.each(artech_engine.report_dump.data["Serial No"], function (i, sn) {
