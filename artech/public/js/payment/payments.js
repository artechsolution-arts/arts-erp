...
artech.payments = class payments extends artech.stock.StockController {
	...
	make_keyboard() {
		var me = this;
		$(this.$body).empty();
		$(this.$body).html(artech_engine.render_template("pos_payment", this.frm.doc));
	...
	make_multimode_payment() {
		...
		this.payments = artech_engine.model.add_child(this.frm.doc, "Multi Mode Payment", "payments");
	...
	show_payment_details() {
		...
		if (this.frm.doc.payments.length) {
			$.each(this.frm.doc.payments, function (index, data) {
				$(
					artech_engine.render_template("payment_details", {
		...
		$(this.$body)
			...
			.text(
				format_currency(
					...
					artech_engine.get_doc(":Company", this.frm.doc.company).default_currency
				)
			);
		this.update_invoice();
	}
