artech.landed_cost_taxes_and_charges = {
		...
		artech_engine.ui.form.on(doctype, {
			...
			set_account_currency: function (frm, cdt, cdn) {
				...
				if (row.expense_account) {
					artech_engine.db.get_value("Account", row.expense_account, "account_currency", function (value) {
						artech_engine.model.set_value(cdt, cdn, "account_currency", value.account_currency);
			...
			set_exchange_rate: function (frm, cdt, cdn) {
				...
				if (row.account_currency == company_currency) {
					...
					artech_engine.call({
						...
						callback: function (r) {
							if (r.message) {
								artech_engine.model.set_value(cdt, cdn, "exchange_rate", r.message);
							}
						},
					});
				}
