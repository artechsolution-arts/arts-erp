artech_engine.provide("artech_engine.help.help_links");

const docsUrl = "https://artech.com/docs/";

artech_engine.help.help_links["Form/Rename Tool"] = [
	{
		label: "Bulk Rename",
...
artech_engine.help.help_links["List/User"] = [
	{
		label: "New User",
...
artech_engine.help.help_links["permission-manager"] = [
	{
...
artech_engine.help.help_links["Form/System Settings"] = [
	{
...
artech_engine.help.help_links["Form/Data Import"] = [
	{
...
artech_engine.help.help_links["List/Data Import"] = [
	{
		label: "Importing and Exporting Data",
		url: docsUrl + "user/manual/en/data-import",
	},
...
artech_engine.help.help_links["module_setup"] = [
	{
...
artech_engine.help.help_links["Form/Document Naming Settings"] = [
	{
		label: "Naming Series",
...
artech_engine.help.help_links["Form/Global Defaults"] = [
	{
...
artech_engine.help.help_links["List/Print Heading"] = [
	{
		label: "Print Heading",
...
artech_engine.help.help_links["Form/Print Heading"] = [
	{
		label: "Print Heading",
		url: docsUrl + "user/manual/en/print-headings",
	},
...
artech_engine.help.help_links["List/Letter Head"] = [
	{
		label: "Letter Head",
...
artech_engine.help.help_links["List/Address Template"] = [
	{
...
artech_engine.help.help_links["List/Terms and Conditions"] = [
	{
...
artech_engine.help.help_links["List/Cheque Print Template"] = [
	{
...
artech_engine.help.help_links["List/Email Account"] = [
	{
		label: "Email Account",
...
artech_engine.help.help_links["List/Notification"] = [
	{
		label: "Notification",
...
artech_engine.help.help_links["Form/Notification"] = [
	{
		label: "Notification",
		url: docsUrl + "user/manual/en/notifications",
	},
...
artech_engine.help.help_links["Form/Email Digest"] = [
	{
		label: "Email Digest",
...
artech_engine.help.help_links["List/Auto Email Report"] = [
	{
...
artech_engine.help.help_links["Form/Print Settings"] = [
	{
...
artech_engine.help.help_links["print-format-builder"] = [
	{
...
artech_engine.help.help_links["Form/PayPal Settings"] = [
	{
...
artech_engine.help.help_links["Form/Razorpay Settings"] = [
	{
...
artech_engine.help.help_links["Form/Dropbox Settings"] = [
	{
...
artech_engine.help.help_links["Form/LDAP Settings"] = [
	{
		label: "LDAP Settings",
...
artech_engine.help.help_links["Form/Stripe Settings"] = [
	{
...
artech_engine.help.help_links["Form/Quotation"] = [
...
artech_engine.help.help_links["List/Customer"] = [
...
artech_engine.help.help_links["Form/Customer"] = [
	{ label: "Customer", url: docsUrl + "user/manual/en/customer" },
	{
		label: "Credit Limit",
		url: docsUrl + "user/manual/en/credit-limit",
...
artech_engine.help.help_links["List/Sales Taxes and Charges Template"] = [
	{
...
artech_engine.help.help_links["Form/Sales Taxes and Charges Template"] = [
	{
		label: "Setting Up Taxes",
		url: docsUrl + "user/manual/en/setting-up-taxes",
	},
...
artech_engine.help.help_links["List/Sales Order"] = [
	{
		label: "Sales Order",
...
artech_engine.help.help_links["Form/Sales Order"] = [
	{
		label: "Sales Order",
		url: docsUrl + "user/manual/en/sales-order",
	},
...
artech_engine.help.help_links["Form/Product Bundle"] = [
	{
...
artech_engine.help.help_links["Form/Selling Settings"] = [
	{
...
artech_engine.help.help_links["List/Supplier"] = [{ label: "Supplier", url: docsUrl + "user/manual/en/supplier" }];

artech_engine.help.help_links["Form/Supplier"] = [{ label: "Supplier", url: docsUrl + "user/manual/en/supplier" }];

artech_engine.help.help_links["Form/Request for Quotation"] = [
	{
...
artech_engine.help.help_links["Form/Supplier Quotation"] = [
	{
...
artech_engine.help.help_links["Form/Buying Settings"] = [
	{
...
artech_engine.help.help_links["List/Purchase Order"] = [
	{
...
artech_engine.help.help_links["Form/Purchase Order"] = [
	{
		label: "Purchase Order",
		url: docsUrl + "user/manual/en/purchase-order",
	},
...
artech_engine.help.help_links["List/Purchase Taxes and Charges Template"] = [
	{
		label: "Setting Up Taxes",
		url: docsUrl + "user/manual/en/setting-up-taxes",
	},
...
artech_engine.help.help_links["List/Price List"] = [
	{
		label: "Price List",
...
artech_engine.help.help_links["List/Authorization Rule"] = [
	{
...
artech_engine.help.help_links["Form/SMS Settings"] = [
	{
		label: "SMS Settings",
...
artech_engine.help.help_links["List/Stock Reconciliation"] = [
	{
...
artech_engine.help.help_links["Tree/Territory"] = [
	{
		label: "Territory",
...
artech_engine.help.help_links["List/Workflow"] = [{ label: "Workflow", url: docsUrl + "user/manual/en/workflows" }];

artech_engine.help.help_links["List/Company"] = [
	{
		label: "Company",
...
artech_engine.help.help_links["Tree/Account"] = [
	{
...
artech_engine.help.help_links["Form/Sales Invoice"] = [
	{
		label: "Sales Invoice",
...
artech_engine.help.help_links["List/Sales Invoice"] = [
	{
		label: "Sales Invoice",
		url: docsUrl + "user/manual/en/sales-invoice",
	},
...
artech_engine.help.help_links["point-of-sale"] = [
	{
...
artech_engine.help.help_links["List/POS Profile"] = [
	{
...
artech_engine.help.help_links["Form/POS Profile"] = [
	{
		label: "POS Profile",
		url: docsUrl + "user/manual/en/pos-profile",
	},
...
artech_engine.help.help_links["List/Purchase Invoice"] = [
	{
...
artech_engine.help.help_links["List/Journal Entry"] = [
	{
		label: "Journal Entry",
...
artech_engine.help.help_links["List/Payment Entry"] = [
	{
		label: "Payment Entry",
...
artech_engine.help.help_links["List/Payment Request"] = [
	{
...
artech_engine.help.help_links["List/Asset"] = [
	{
...
artech_engine.help.help_links["List/Asset Category"] = [
	{
...
artech_engine.help.help_links["Tree/Cost Center"] = [
	{ label: "Budgeting", url: docsUrl + "user/manual/en/budgeting" },
];

//Stock

artech_engine.help.help_links["List/Item"] = [
...
artech_engine.help.help_links["Form/Item"] = [
	{ label: "Item", url: docsUrl + "user/manual/en/item" },
	{
		label: "Item Price",
		url: docsUrl + "user/manual/en/item-price",
...
artech_engine.help.help_links["List/Purchase Receipt"] = [
	{
...
artech_engine.help.help_links["List/Delivery Note"] = [
	{
		label: "Delivery Note",
...
artech_engine.help.help_links["Form/Delivery Note"] = [
	{
		label: "Delivery Note",
		url: docsUrl + "user/manual/en/delivery-note",
	},
...
artech_engine.help.help_links["List/Installation Note"] = [
	{
...
artech_engine.help.help_links["List/Budget"] = [{ label: "Budgeting", url: docsUrl + "user/manual/en/budgeting" }];

artech_engine.help.help_links["List/Material Request"] = [
	{
...
artech_engine.help.help_links["Form/Material Request"] = [
	{
		label: "Material Request",
		url: docsUrl + "user/manual/en/material-request",
	},
...
artech_engine.help.help_links["Form/Stock Entry"] = [
...
artech_engine.help.help_links["List/Stock Entry"] = [
	{ label: "Stock Entry", url: docsUrl + "user/manual/en/stock-entry" },
];

artech_engine.help.help_links["Tree/Warehouse"] = [
	{ label: "Warehouse", url: docsUrl + "user/manual/en/warehouse" },
];

artech_engine.help.help_links["List/Serial No"] = [
	{ label: "Serial No", url: docsUrl + "user/manual/en/serial-no" },
];

artech_engine.help.help_links["Form/Serial No"] = [
	{ label: "Serial No", url: docsUrl + "user/manual/en/serial-no" },
];

artech_engine.help.help_links["List/Batch"] = [{ label: "Batch", url: docsUrl + "user/manual/en/batch" }];

artech_engine.help.help_links["Form/Batch"] = [{ label: "Batch", url: docsUrl + "user/manual/en/batch" }];

artech_engine.help.help_links["Form/Packing Slip"] = [
	{
		label: "Packing Slip",
...
artech_engine.help.help_links["Form/Quality Inspection"] = [
	{
...
artech_engine.help.help_links["Form/Landed Cost Voucher"] = [
	{
...
artech_engine.help.help_links["Tree/Item Group"] = [
	{
		label: "Item Group",
...
artech_engine.help.help_links["Form/Item Attribute"] = [
	{
...
artech_engine.help.help_links["Form/UOM"] = [
	{
...
artech_engine.help.help_links["Form/Stock Reconciliation"] = [
	{
...
artech_engine.help.help_links["Form/Lead"] = [{ label: "Lead", url: docsUrl + "user/manual/en/lead" }];

artech_engine.help.help_links["Form/Opportunity"] = [
	{ label: "Opportunity", url: docsUrl + "user/manual/en/opportunity" },
];

artech_engine.help.help_links["Form/Address"] = [{ label: "Address", url: docsUrl + "user/manual/en/address" }];

artech_engine.help.help_links["Form/Contact"] = [{ label: "Contact", url: docsUrl + "user/manual/en/contact" }];

artech_engine.help.help_links["Form/Newsletter"] = [
	{ label: "Newsletter", url: docsUrl + "user/manual/en/newsletter" },
];

artech_engine.help.help_links["Form/Campaign"] = [{ label: "Campaign", url: docsUrl + "user/manual/en/campaign" }];

artech_engine.help.help_links["Tree/Sales Person"] = [
	{
		label: "Sales Person",
...
artech_engine.help.help_links["Form/Sales Person"] = [
	{
...
artech_engine.help.help_links["Form/BOM"] = [
	{
...
artech_engine.help.help_links["Form/Work Order"] = [
	{
		label: "Work Order",
...
artech_engine.help.help_links["Form/Workstation"] = [
	{
		label: "Workstation",
...
artech_engine.help.help_links["Form/Operation"] = [
	{
		label: "Operation",
...
artech_engine.help.help_links["Form/BOM Update Tool"] = [
	{
...
artech_engine.help.help_links["Form/Customize Form"] = [
	{
		label: "Custom Field",
...
artech_engine.help.help_links["List/Custom Field"] = [
	{
		label: "Custom Field",
		url: docsUrl + "user/manual/en/custom-field",
	},
...
artech_engine.help.help_links["Form/Custom Field"] = [
	{
		label: "Custom Field",
		url: docsUrl + "user/manual/en/custom-field",
	},
