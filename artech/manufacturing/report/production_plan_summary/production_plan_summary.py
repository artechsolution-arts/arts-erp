...
def get_production_plan_item_details(filters, data, order_details):
	production_plan_doc = artech_engine.get_cached_doc("Production Plan", filters.get("production_plan"))
			...
			data.append(
				{
					...
					"item_name": artech_engine.get_cached_value("Item", row.item_code, "item_name"),
					"qty": order_qty,
