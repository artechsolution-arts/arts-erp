...
from artech_engine.utils import add_years, cint, flt, getdate
...
class ForecastingReport(ExponentialSmoothingForecast):
	def __init__(self, filters=None):
		...
		self.company_currency = artech.get_company_currency(self.filters.company)
	...
	def get_data_for_forecast(self):
		parent = artech_engine.qb.DocType(self.doctype)
		child = artech_engine.qb.DocType(self.child_doctype)
