...
artech_engine.query_reports["Production Planning Report"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
		...
		},
		{
			...
			on_change: function () {
				...
				let based_on = artech_engine.query_report.get_filter_value("based_on");
				let options = {
		...
		},
		{
			...
			get_data: function (txt) {
				...
				return artech_engine.db.get_link_options(based_on, txt);
			},
			get_query: function () {
