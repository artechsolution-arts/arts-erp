...
from artech_engine.utils import date_diff, flt, getdate, today

from artech.stock.report.stock_analytics.stock_analytics import get_period, get_period_date_ranges
...
def get_chart_based_on_status(data):
	labels = artech_engine.get_meta("Work Order").get_options("status").split("\n")
	if "" in labels:
		labels.remove("")
