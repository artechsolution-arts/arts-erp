...
from artech.manufacturing.doctype.routing.test_routing import create_routing, setup_bom
from artech.manufacturing.doctype.workstation.workstation import (
...
class TestWorkstation(ArtechTestSuite):
	...
	def test_update_bom_operation_rate(self):
		...
		w1 = artech_engine.get_doc("Workstation", "_Test Workstation A")
		# resets values
...
def make_workstation(*args, **kwargs):
	...
	if not artech_engine.db.exists("Workstation", workstation_name):
		doc = artech_engine.get_doc({"doctype": "Workstation", "workstation_name": workstation_name})
	...
	return artech_engine.get_doc("Workstation", workstation_name)
