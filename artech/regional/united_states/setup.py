...
def setup(company=None, patch=True):
	...
	if artech_engine.db.count("Company", {"country": "United States"}) <= 1:
...
def add_print_formats():
	artech_engine.reload_doc("regional", "print_format", "irs_1099_form")
	artech_engine.db.set_value("Print Format", "IRS 1099 Form", "disabled", 0)
