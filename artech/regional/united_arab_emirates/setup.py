...
def add_print_formats():
	artech_engine.reload_doc("regional", "print_format", "detailed_tax_invoice")
	artech_engine.reload_doc("regional", "print_format", "simplified_tax_invoice")
	artech_engine.reload_doc("regional", "print_format", "tax_invoice")
...
def add_custom_roles_for_reports():
	...
	if not artech_engine.db.get_value("Custom Role", dict(report="UAE VAT 201")):
