from artech.crm.report.opportunity_summary_by_sales_stage.opportunity_summary_by_sales_stage import (
	execute,
)
from artech.crm.report.sales_pipeline_analytics.test_sales_pipeline_analytics import (
	create_opportunity,
)
from artech.tests.utils import ArtechTestSuite


class TestOpportunitySummaryBySalesStage(ArtechTestSuite):
	def setUp(self):
		create_opportunity()
