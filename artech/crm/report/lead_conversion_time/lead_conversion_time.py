...
from artech_engine.utils import date_diff, flt
...
def get_communication_details(filters):
	...
	communication_list = []
	opportunities = artech_engine.db.get_values(
		"Opportunity",
	...
	for d in opportunities:
		...
		communication_count = artech_engine.db.sql(
			"""
				SELECT
					count(*)
				FROM
		...
		first_contact = artech_engine.db.sql(
			"""
				SELECT
		...
		support_tickets = len(artech_engine.db.get_all("Issue", {"raised_by": d.contact_email}))
