...
class TestProspect(ArtechTestSuite):
	...
	def test_make_customer_from_prospect(self):
		...
		artech_engine.delete_doc_if_exists("Customer", "_Test Prospect")
...
def make_prospect(**args):
	...
	prospect_doc = artech_engine.get_doc(
		{
			"doctype": "Prospect",
