...
artech_engine.ui.form.on("Contract", {
	contract_template: function (frm) {
		if (frm.doc.contract_template) {
			artech_engine.call({
				method: "artech.crm.doctype.contract_template.contract_template.get_contract_template",
				args: {
	...
	party_name: function (frm) {
		...
		artech_engine.db.get_value(frm.doc.party_type, frm.doc.party_name, field, (r) => {
