artech_engine.listview_settings["Task"] = {
	add_fields: [
		"project",
		"status",
		"priority",
	...
	onload: function (listview) {
		var method = "artech.projects.doctype.task.task.set_multiple_status";
	...
	gantt_custom_popup_html: function (ganttobj, task) {
		...
		if (task._assign) {
			...
			const assignment_wrapper = `
				...
				<span>
					${assign_list.map((user) => artech_engine.user_info(user).fullname).join(", ")}
				</span>
			`;
