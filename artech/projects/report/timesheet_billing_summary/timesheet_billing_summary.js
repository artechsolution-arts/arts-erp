...
artech_engine.query_reports["Timesheet Billing Summary"] = {
	tree: true,
	initial_depth: 0,
	filters: [
		{
		...
		},
		{
			...
			label: __("From Date"),
			fieldtype: "Date",
			default: artech_engine.datetime.add_months(artech_engine.datetime.month_start(), -1),
		},
		{
			fieldname: "to_date",
			label: __("To Date"),
			fieldtype: "Date",
			default: artech_engine.datetime.add_days(artech_engine.datetime.month_start(), -1),
		},
		{
