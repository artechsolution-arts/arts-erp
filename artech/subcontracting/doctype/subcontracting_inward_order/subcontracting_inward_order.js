...
artech_engine.ui.form.on("Subcontracting Inward Order", {
	setup: (frm) => {
	...
	update_subcontracting_inward_order_status(frm, status) {
		artech_engine.call({
			method: "artech.subcontracting.doctype.subcontracting_inward_order.subcontracting_inward_order.update_subcontracting_inward_order_status",
			args: {
				scio: frm.doc.name,
				status: status,
			},
