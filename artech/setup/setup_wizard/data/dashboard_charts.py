...
def get_company_for_dashboards():
	...
	if company:
		...
		company_list = artech_engine.get_list("Company")
		if company_list:
...
def get_default_dashboards():
	company = artech_engine.get_doc("Company", get_company_for_dashboards())
...
def get_account(account_type, company):
	accounts = artech_engine.get_list("Account", filters={"account_type": account_type, "company": company})
	if accounts:
