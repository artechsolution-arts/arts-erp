...
from artech.setup.demo import setup_demo_data
from artech.setup.setup_wizard.operations import install_fixtures as fixtures
...
def setup_defaults(args):
	fixtures.install_defaults(artech_engine._dict(args))
