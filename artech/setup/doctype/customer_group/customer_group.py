...
class CustomerGroup(NestedSet):
	...
	def validate_currency_for_receivable_and_advance_account(self):
		for x in self.accounts:
			...
			if x.account:
				receivable_account_currency = artech_engine.get_cached_value(
...
def get_parent_customer_groups(customer_group):
	lft, rgt = artech_engine.db.get_value("Customer Group", customer_group, ["lft", "rgt"])
...
def on_doctype_update():
	artech_engine.db.add_index("Customer Group", ["lft", "rgt"])
